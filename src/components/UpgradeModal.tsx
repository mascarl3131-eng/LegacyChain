    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: '0.75rem', padding: '0.75rem', borderRadius: 9, border: '1px solid rgba(0,255,209,0.16)', background: 'rgba(0,255,209,0.035)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '0.4rem 0.75rem', color: 'rgba(239,246,255,0.45)', fontSize: '0.55rem' }}>
          ...
          <div style={{ color: 'rgba(239,246,255,0.25)', fontSize: '0.5rem', lineHeight: 1.5, textAlign: 'center', marginTop: '0.48rem' }}>
