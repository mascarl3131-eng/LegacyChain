...
export default function FamilyLegacyTab() {
  ...
  return (
    <div>
      ...
      <div className="glass-card" style={{ padding: '.55rem', marginBottom: '.9rem', display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '.45rem', position: 'sticky', top: 0, zIndex: 5, backdropFilter: 'blur(12px)' }}>
